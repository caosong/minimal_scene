...
const ANNdist   ANN_DIST_INF = INT_MAX;
...
//----------------------------------------------------------------------
//#define ANN_POW(v)                    (((int)v)*((int)v))
//#define ANN_ROOT(x)                   sqrt(x)
//#define ANN_SUM(x,y)          (((int)x) + ((int)y))
//#define ANN_DIFF(x,y)         (((int)y) - ((int)x))
...
DLL_API ANNpoint annAllocPts(int n,    // number of points
                             int dim); // dimension
...
public:
    ...
    ANNpoint thePoints() // return pointer to points
    {  return pts;  }
};
...
protected:
    ...
    void SkeletonTree( // construct skeleton tree
                      ...
                      int dd,   // dimension
                      int bs,   // bucket size
                      ANNpoint pa = NULL,      // point array (optional)
