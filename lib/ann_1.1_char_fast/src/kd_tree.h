...
public:
    ~ANNkd_node() {}   // virtual destructor

    bool isLeaf;

    void ann_search(ANNdist) { };               // tree search
    void ann_pri_search(ANNdist, ANNprTempStore&) { };  // priority search
    void ann_FR_search(ANNdist) { };    // fixed-radius search
    ...
    void dump(ostream &out) { };                // dump node
...
typedef void (*ANNkd_splitter)(  // splitting routine for kd-trees
        const ANNpoint pa,  // point array (unaltered)
...
class ANNkd_leaf: public ANNkd_node             // leaf node for kd-tree
{
    ...
    unsigned short n_pts;       // no. points in bucket
...
public:
    ...
    void print(int level, ostream &out);// print node
    void dump(ostream &out);                        // dump node
    
    void ann_search(ANNdist);                      // standard search
    void ann_pri_search(ANNdist, ANNprTempStore&); // priority search
    void ann_FR_search(ANNdist);            // fixed-radius search
};
...
class ANNkd_split : public ANNkd_node   // splitting node of a kd-tree
{
    ...
    unsigned char cut_dim;      // dim orthogonal to cutting plane
...
ANNkd_ptr rkd_tree(                             // recursive construction of kd-tree
        ANNpoint           pa,                             // point array (unaltered)
